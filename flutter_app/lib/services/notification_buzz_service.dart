...
class NotificationCommandPolicy {
  ...
  static NotificationCommandPolicy defaults() => NotificationCommandPolicy(
        ...
        maxActuationsPerMinute: 25,
        emergencyCooldownSeconds: 45,
        dedupeWindowMs: 15 * 1000,
        maxDedupSignatures: 128,
        buzzLevel: 10,
        buzzLoopMultiplier: 3,
        buzzMaxQueueAdd: 60,
        buzzGapMs: 600,
        defaultDurationMs: 500,
        minDurationMs: 50,
        maxDurationMs: 10 * 1000,
        zapDefaultStrength: 64,
        zapMaxStrength: 100,
        appRules: const <String, NotificationCommandAppRule>{},
      );
